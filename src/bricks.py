...
game_lvl2 = Level(
    ...
    scene_elements=[
        Mountain(300, 250, 250, BROWN_COLOR, WHITE_COLOR),
        Mountain(500, 275, 275, BROWN_COLOR, WHITE_COLOR),
        Mountain(100, 275, 300, BROWN_COLOR, WHITE_COLOR),
        Mountain(-30, 230, 230, BROWN_COLOR, WHITE_COLOR),
        Clouds(-15, 35),
        Clouds(-400, 25),
        Clouds(-850, 45),
        Flower(50, 50, 65),
...
game_lvl4 = Level(
    ...
    scene_elements=[
        ...
        Building(400, GREY_COLOR_2, YELLOW_COLOR, 13, 3, False),
        Building(250, GREY_COLOR_2, YELLOW_COLOR, 16, 3, True),
